...
define ('ACCESS_TOKEN_MERCADO_PAGO', 'APP_USR-1849258831863765-091422-9092e84d861ca16e1db55c6d1ec73552-626586876');

// porcentagem de lucro sobre os valores cobrados no site, já feita a converção
define ('PORCENTAGEM_LUCRO', 120); // %

// lista de ids de adms
define ('ADMS', [824748678]);

define ('CHAT_ID_NOTIFICACAO', '-1001267513039'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-1001267513039'); // grupo de bot
//define ('GRUPO_ID','-1001267513039'); // grupo de bot
